...
#line 136 "parser.hpp" // lalr1.cc:377
  ...
  public:
    ...
    union union_type
    {
      ...
      // addexpr
      // expr
      char dummy1[sizeof(class CalculationNode*)];
  ...
  basic_symbol (typename Base::kind_type t, const class CalculationNode* v, const location_type& l);
    ...
    , location (other.location)
  {
      switch (other.type_get ())
    {
      ...
      case 22: // addexpr
      case 23: // expr
        value.copy< class CalculationNode* > (other.value);
        break;
    ...
    , location (l)
  {
      ...
      switch (this->type_get ())
    {
      ...
      case 22: // addexpr
      case 23: // expr
        value.copy< class CalculationNode* > (v);
        break;
  ...
  template <typename Base>
   Parser ::basic_symbol<Base>::basic_symbol (typename Base::kind_type t, const class CalculationNode* v, const location_type& l)
    : Base (t)
    , value (v)
    , location (l)
  {}
   ...
   Parser ::basic_symbol<Base>::clear ()
  {
   ...
   default:
    ...
    switch (yytype)
    {
      ...
      case 22: // addexpr
      case 23: // expr
        value.template destroy< class CalculationNode* > ();
        break;
   ...
   Parser ::basic_symbol<Base>::move (basic_symbol& s)
  {
      ...
      switch (this->type_get ())
    {
      ...
      case 22: // addexpr
      case 23: // expr
        value.move< class CalculationNode* > (s.value);
        break;
