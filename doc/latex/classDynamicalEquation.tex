...
\index{Dynamical\+Equation@{Dynamical\+Equation}!test\+Node\+Ids@{test\+Node\+Ids}}
\index{test\+Node\+Ids@{test\+Node\+Ids}!Dynamical\+Equation@{Dynamical\+Equation}}
\subsubsection[{\texorpdfstring{test\+Node\+Ids(void) const }{testNodeIds(void) const }}]{\setlength{\rightskip}{0pt plus 5cm}bool Dynamical\+Equation\+::test\+Node\+Ids (
\begin{DoxyParamCaption}
\item[{void}]{}
\end{DoxyParamCaption}
) const}\hypertarget{classDynamicalEquation_adbf7e8bad4b2764922b0ba2fe077b297}{}\label{classDynamicalEquation_adbf7e8bad4b2764922b0ba2fe077b297}
Used only for testing purposes. For all ID type Calculation\+Nodes in the equation compares the id field to the assignes node\textquotesingle{}s id. 
